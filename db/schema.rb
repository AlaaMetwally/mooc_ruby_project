...
ActiveRecord::Schema.define(version: 20180517160510) do
  ...
  create_table "lectures", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.index ["cached_votes_down"], name: "index_lectures_on_cached_votes_down"
    t.index ["cached_votes_score"], name: "index_lectures_on_cached_votes_score"
    t.index ["cached_votes_total"], name: "index_lectures_on_cached_votes_total"
    t.index ["cached_votes_up"], name: "index_lectures_on_cached_votes_up"
    t.index ["cached_weighted_average"], name: "index_lectures_on_cached_weighted_average"
    t.index ["cached_weighted_score"], name: "index_lectures_on_cached_weighted_score"
    t.index ["cached_weighted_total"], name: "index_lectures_on_cached_weighted_total"
